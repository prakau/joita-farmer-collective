...
apk="$project_dir/release/JOITA-BioSeed-AI-Soil-Saathi-4.0.0.apk"
expected_apk_sha="d0815e1f1490636e9469f95613e879267cfdcbf3d75461887b10c7f7cf905eb5"
...
grep -q "package: name='ai.joita.biosoil' versionCode='40000' versionName='4.0.0'" <<< "$badging"
