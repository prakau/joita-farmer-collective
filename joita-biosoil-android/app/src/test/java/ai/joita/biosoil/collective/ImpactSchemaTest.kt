...
class ImpactSchemaTest {
    ...
    @Test fun incompleteAnswersStayUnknownAndRequireOfficerAndStage() {
        assertNull(ImpactSchema.validate(baseline, "24-09-2026", "कर्मी"))
    ...
    @Test fun readingsNeedValidRangesAndUnits() {
        ...
        assertNull(ImpactSchema.validate(baseline + mapOf("ec" to "0.5", "ecUnit" to "dS/m", "ph" to "7.2", "temperature" to "-2"), "24-09-2026", "Officer"))
    }
    @Test fun datesAndStableQuestionKeysAreValidated() {
        assertNotNull(ImpactSchema.validate(baseline + ("followupDate" to "31-02-2026"), "24-09-2026", "Officer"))
